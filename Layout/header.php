                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-4">
                            <div class="left-header clearfix">
                                <ul>
                                    <li><p><i class="fa fa-phone" aria-hidden="true"></i>(+84) 343 888 776</p></li>
                                    ...
                                    <div class="mobile-menu">
                                        <nav id="dropdown">
                                            <ul>
                                                ...
                                                <li><a href="#">Blog</a>
                                                        <ul>
                                                            <li><a href="/Blog_1.html">7 TIPS PHỐI ĐỒ VỚI VARSITY JACKET</a></li>
                                                            <li><a href="/Blog_2.html">CÚ BẮT TAY ĐẬM CHẤT VĂN HÓA ĐƯỜNG PHỐ</a></li>
                                                            <li><a href="/Blog_3.html">THÔNG TIN CHƯƠNG TRÌNH</a></li>
                                                        </ul>
                                                </li>
                                                <li><a href="contact_us.php">Contact</a></li>
                                            </ul>
