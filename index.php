                ...
                <div class="bend niceties preview-2 hm-ver-1">
                    ...
                    <div id="slider-direction-3" class="t-cn slider-direction Builder">
                        <div class="slide-all">
                            ...
                            <!-- layer 2 -->
                            <div class="layer-2">
                                <h2 class="title6">2TQN Fashion</h2>
                            </div>
                            <!-- layer 2 -->
                            <div class="layer-2">
                            ...
                            <div class="banner-box banner-box-re">
                                <a href="shop.php?id_category=3">
                                    ...
                                    <div>
                                        ...
                                        <p>Duyên dáng sang trọng, chất lượng vượt thời gian - 2TQN Store, nơi phong cách trở thành đẳng cấp.</p>
                                    </div>
                                </a>
                            </div>
					...
					<div id="blog" class="owl-carousel product-slider owl-theme re-blog">
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                ...
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <div class="name">Phụ kiện thời trang - Khám Phá Sự Lịch Lãm Tại 2TQN Store</div>
                                    </h2>
                                    <div class="blog-meta">
                                        <span class="post-category">
                                            in
                                            <a rel="category" href="blog.html">2TQN Store</a>
                                        </span>
						...
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                ...
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <div class="name">Áo Sơ Mi - Khám Phá Sự Tinh Tế Tại 2TQN Store</div>
                                    </h2>
                                    <div class="blog-meta">
                                        <span class="post-category">
                                            in
                                    ...
                                    <div class="blog-content"> 
                                    2TQN Store tự hào về bộ sưu tập áo sơ mi nam phong phú từ các thương hiệu hàng đầu thế giới. 
						...
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                ...
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <div class="name">Giày - Khám Phá Sự Hoàn Hảo Tại 2TQN Store</div>
                                    </h2>
                                    <div class="blog-meta">
                                        <span class="post-category">
                                            in
                                    ...
                                    <div class="blog-content"> 
                                    Tại 2TQN Store, chúng tôi hiểu rằng đôi giày không chỉ là một phần của bộ trang phục mà còn là biểu tượng của phong cách và đẳng cấp. 
						...
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                ...
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <div class="name">Áo Vest - Sự Lịch Lãm Tại 2TQN Store</div>
                                    </h2>
                                    <div class="blog-meta">
                                        <span class="post-category">
                                            in
